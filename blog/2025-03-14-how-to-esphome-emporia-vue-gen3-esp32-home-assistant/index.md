---
title: How To Install ESPHome on Emporia Vue Gen 3 Power Monitoring w/ Home Assistant
date: "2025-03-14"
...
Full in Depth Video 
<iframe allowfullscreen height="353" src="https://www.youtube.com/embed/Z52y1Gm4VAg" width="625" youtube-src-=""></iframe>   

We've covered the Gen 2 model in the [previous video](https://youtu.be/z0Jv4nO9OWg), but in a quick TL;DR.  It's a box that goes in your breaker panel to measure the entire power usage in your home as well as breaking it down into additional 16 other circuits in your home for a more detailed usage.  This isn't any AI, or guess work involved like other brands, it measures the real world usage of each of the 16 circuits you install the clamps on in the breaker panel. 
...
Purchase on Amazon (affiliate) - https://amzn.to/4iEEmNY  
...
PCBite is another brand of probes that can be used instead of BDM pins - [Amazon](https://amzn.to/4hKowQF)
...
Keep in mind, do not transpose the RX/TX pins like you normally do.  USB TTL RX goes to Emporia RXD and TX goes to TXD this time around.
...
Additional ESPHome Emporia Vue3 configs - https://github.com/emporia-vue-local/esphome/discussions/264
